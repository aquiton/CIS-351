...
public class SampleSigned16BitAdderTest {
  ...
  public static final long testIntegers[] = {-32768, -32767, 0, 1, 2, 13, 127, 128, 129, 32766, 32767,21000,21845};
  public static final long outofRange[] = {-55555, -65232, 55555, 75889, 80212};
//21845
  ...
  // //larger than 16 bit test
  // @Test
  // public void bigger_than_sixteen(){
  //   for (long a : outofRange){
  //     for (long b : outofRange){
  //       verify(a, b, false);
  //       verify(a, b, true);
  //     }
  //   }
  // }
  // //overflow can occur but doesn't occur
  // @Test
  // public void noOverflow(){
  //   verify(500, 505, false);
  //   verify(500, 505, true);
  // }
